...
IPV4_ENDPOINT="https://10.10.1.118:6443"
...
echo "   talosctl config endpoint 10.10.1.118"
echo "   talosctl config nodes 10.10.1.118"
echo ""
...
echo "📍 IPv4: 10.10.1.118, IPv6: $IPV6_ADDRESS"